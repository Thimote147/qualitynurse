          ...
          <div className="max-w-7xl mx-auto">
            <div className="max-w-4xl">
              ...
              <div className="space-y-3 sm:space-y-4 text-base sm:text-lg md:text-xl text-white/90 mb-6 sm:mb-8">
                ...
                <p className="leading-relaxed">
                  La volonté du groupe Q&N est d'élever la qualité de service au rang de vertu.
                </p>
                <p className="leading-relaxed">
                  La prise en charge de patients atteints de pathologies lourdes requiert une expertise 
                  que seuls des professionnels de la santé peuvent offrir.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-16">
            ...
            <p className="text-sm sm:text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Des soins professionnels à domicile avec plus de 20 années d'expérience
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Tous types de soins infirmiers dans le confort de votre domicile',
              ...
              },
              {
                ...
                description: 'Service d\'urgence disponible jour et nuit, toute l\'année',
              ...
              },
              {
                ...
                description: '20 années d\'expérience en soins infirmiers spécialisés',
              ...
              },
              {
                ...
                description: 'Professionnels diplômés et matériel médical de pointe',
              ...
              >
                <div className={`inline-flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-${service.color}-100 text-${service.color}-600 rounded-lg mb-3 sm:mb-4 group-hover:scale-110 transition-transform`}>
                  {service.icon}
                </div>
          ...
          <div className="text-center mt-8 sm:mt-12">
            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg border-l-4 border-emerald-600 max-w-2xl mx-auto">
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6">
                Notre équipe est disponible 24h/24 pour répondre à vos urgences médicales
              </p>
